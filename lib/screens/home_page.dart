              ...
              : const SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    HomeHeader(),
                    DiscountBanner(),
                    JadwalPasienCard(), // <--- JADWAL CARD DITAMBAHKAN DI SINI
...
class Categories extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    List<Map<String, dynamic>> categories = [
      {"icon": flashIcon, "text": "Pengingat\nCairan"},
      {"icon": billIcon, "text": "Pengingat\nMakan"},
      {"icon": gameIcon, "text": "Pengingat\nBerat Badan"},
      {"icon": giftIcon, "text": "Pengingat\nTensi"},
    ];
    return Padding(
...
List<Product> demoProducts = [
  Product(
    id: 1,
    images: ['lib/assets/images/logo.png'],
    colors: [
