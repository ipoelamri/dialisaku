...
import 'package:dialisaku/services/get_jadwal_pasien_service.dart';
import 'package:riverpod_annotation/riverpod_annotation.dart';

part 'get_jadwal_pasien_provider.g.dart';
...
Future<ModelGetJadwalResponse> getJadwalPasien(GetJadwalPasienRef ref) async {
  ...
  final jadwalService = GetJadwalPasienService();
  final jadwalResponse = await jadwalService.fetchGetJadwal(token);
